...
// import sadafImage from '.Home/Images/sadafimage.jpg'; // Assuming Images is in the same folder as Homepp.js or adjust path
import adnanimage from './Images/adnanimage.jpg'; // Corrected import path for adnan image
import umarimage from './Images/umarimage.jpg';
// ... other imports (like React, icons, etc.)
...
const teamMembers = [
    {
        ...
        // image: sadafImage, // Use the imported variable here
        social: {
    ...
    },
    {
        ...
        image: adnanimage, // Use the imported variable here
        social: {
    ...
    },
    {
        ...
        image: umarimage, // Use the imported variable here
        social: {
...
const Home = () => {
  ...
  const handleRequestDemo = () => {
    alert("Thank you for your interest! A CardioSense AI specialist will contact you shortly for a personalized demo and to discuss your needs.");
      ...
      <nav className="sticky top-0 bg-white dark:bg-gray-900 shadow-xl z-50 transition-colors duration-300"> {/* Stronger shadow, transition */}
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          <a
            ...
            aria-label="CardioSense AI Home"
          >
            CardioSense AI
          </a>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg md:text-xl max-w-3xl mb-6 drop-shadow-md opacity-0 animate-fade-in-up-delay-300">
            Empowering healthcare professionals and patients with <strong className="text-white">real-time, AI-driven insights</strong> for early detection and continuous cardiac monitoring via <strong className="text-yellow-300">CardioSense AI</strong>.
          </p>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 md:pr-8 text-center md:text-left">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed animate-fade-in-up-delay-400">
              This groundbreaking solution, known as **CardioSense AI**, provides real-time heart sound insights and advanced AI diagnostics. This significantly accelerates early diagnosis and enables consistent oversight, particularly in underserved and remote communities.
            </p>
          </div>
<div className="md:w-1/2 relative mt-10 md:mt-0 animate-fade-in-up-delay-500">
    {/* UPDATED: Video showing CardioSense AI device in use or demonstrating its features */}
    <div className="relative w-full aspect-video rounded-xl shadow-2xl transform transition-transform duration-500 hover:scale-105 border border-blue-300 dark:border-blue-600 overflow-hidden">
        <video
            src={liveVideoMP4} // <--- Yahan 'liveVideoMP4' variable use hoga!
            ...
            muted // Auto-play کے لیے muted hona zaroori hai
            autoPlay // Page load hone par automatically play karne ke liye
            preload="auto" // Video ko jaldi load karne ke liye
            className="absolute inset-0 w-full h-full object-cover"
            aria-label="CardioSense AI device in action: real-time PCG monitoring demonstration video."
        >
    ...
    <div className="absolute bottom-4 left-4 bg-white dark:bg-gray-700 p-3 rounded-lg shadow-md text-sm text-gray-600 dark:text-gray-200 font-medium transform transition-transform hover:scale-105">
      ...
      <section id="live-demo" ref={(el) => (sectionRefs.current[1] = el)} className="py-20 bg-gray-100 dark:bg-gray-800 flex justify-center items-center overflow-hidden px-6">
        <div className="w-full max-w-5xl bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-12 text-center border border-blue-200 dark:border-blue-700 animate-fade-in-up">
          <h2 className="text-4xl font-extrabold mb-8 text-blue-700 dark:text-blue-400">
            CardioSense AI In Action: Live PCG Monitoring & AI Insights
          </h2>
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-10 max-w-2xl mx-auto">
            Witness how CardioSense AI captures, processes, and visualizes heart sounds, bringing complex diagnostics to an intuitive platform.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div
              aria-label="CardioSense AI Dashboard Screenshot"
      ...
      <section id="features" ref={(el) => (sectionRefs.current[2] = el)} className="py-20 md:py-32 bg-white dark:bg-gray-900 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800 dark:text-gray-100 mb-6 animate-fade-in-up-delay-100">
            Unlock the Power of CardioSense AI
          </h2>
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16 animate-fade-in-up-delay-200">
            CardioSense AI integrates cutting-edge IoT and AI to deliver unparalleled insights into cardiac health, revolutionizing patient care.
          </p>
      ...
      <section id="how-it-works" ref={(el) => (sectionRefs.current[3] = el)} className="py-20 md:py-32 bg-gray-100 dark:bg-gray-800 px-6">
          <div className="container mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16 animate-fade-in-up-delay-200">
                  CardioSense AI simplifies advanced cardiac diagnostics into an easy, efficient, and intelligent process.
              </p>
      ...
      <section id="technology" ref={(el) => (sectionRefs.current[4] = el)} className="py-20 md:py-32 bg-white dark:bg-gray-900 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16 animate-fade-in-up-delay-200">
            CardioSense AI leverages a robust and modern technology stack to deliver reliable, scalable, and secure cardiac monitoring.
          </p>
      ...
      <section id="team" ref={(el) => (sectionRefs.current[5] = el)} className="py-20 md:py-32 bg-gray-50 dark:bg-gray-800 px-6">
          <div className="container mx-auto text-center">
              <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800 dark:text-gray-100 mb-6 animate-fade-in-up-delay-100">
                  Meet the Innovators Behind CardioSense AI
              </h2>
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16 animate-fade-in-up-delay-200">
                  Our team's innovation, expertise, and a unified vision drive our mission to redefine cardiac care.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 justify-center"> {/* Changed to lg:grid-cols-3 and added justify-center */}
                  {teamMembers.slice(0, 3).map((member, index) => (
                      <div
                          key={index} // CORRECTED: Key is now on the outermost element of the map.
      ...
      <section id="testimonials" ref={(el) => (sectionRefs.current[6] = el)} className="py-20 md:py-32 bg-gray-100 dark:bg-gray-800 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16 animate-fade-in-up-delay-200">
            Real stories from healthcare professionals, patients, and innovators who believe in CardioSense AI's potential.
          </p>
      ...
      <section id="faq" ref={(el) => (sectionRefs.current[7] = el)} className="py-20 md:py-32 bg-white dark:bg-gray-900 px-6">
        <div className="container mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto text-center mb-16 animate-fade-in-up-delay-200">
            Find quick answers to the most common questions about CardioSense AI, its technology, and its applications.
          </p>
      ...
      <section ref={(el) => (sectionRefs.current[9] = el)} className="py-20 bg-blue-700 dark:bg-blue-900 text-white text-center px-6 animate-fade-in-up">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
            Stay Ahead with CardioSense AI Updates
          </h2>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 shadow-lg text-left animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="space-y-6 text-lg text-gray-700 dark:text-gray-300">
                    <div className="flex items-center">
                        ...
                        <span>123 CardioSense AI Avenue, Health City, Karachi, Pakistan</span>
                    </div>
                    <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <a href="mailto:info@cardiosenseai.com" className="hover:underline">info@cardiosenseai.com</a>
                    </div>
                    <div className="flex items-center">
                ...
                <div className="mt-10">
                    ...
                    <div className="flex space-x-6 justify-center lg:justify-start">
                        <a href="https://linkedin.com/cardiosenseai" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-600 dark:text-gray-300 hover:text-blue-700 dark:hover:text-blue-400 transition-colors duration-200">
                            <FaLinkedin className="text-3xl" />
                        </a>
                        <a href="https://twitter.com/cardiosenseai" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-600 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-300 transition-colors duration-200">
                            <FaTwitter className="text-3xl" />
                        </a>
                        <a href="https://facebook.com/cardiosenseai" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-600 dark:text-gray-300 hover:text-blue-800 dark:hover:text-blue-500 transition-colors duration-200">
      ...
      <section id="awards" ref={(el) => (sectionRefs.current[11] = el)} className="py-20 bg-gray-100 dark:bg-gray-800 px-6">
          <div className="container mx-auto text-center">
              <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800 dark:text-gray-100 mb-6 animate-fade-in-up-delay-100">
                  Awards & Recognition: Our Journey to Excellence
              </h2>
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16 animate-fade-in-up-delay-200">
                  CardioSense AI's innovations and positive impact on healthcare have earned us recognition.
              </p>
      ...
      <footer className="bg-gray-800 dark:bg-gray-950 text-gray-300 py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-3xl font-extrabold text-white mb-4">CardioSense AI</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-center">
                ...
                <span>123 CardioSense AI Avenue, Health City, Islamabad, Pakistan</span>
              </li>
              <li className="flex items-center">
                <FaPhone className="mr-3 text-blue-400" />
                <a href="tel:+923059554995" className="hover:underline">+923059554995</a>
              </li>
              <li className="flex items-center">
          ...
          <div>
            ...
            <div className="flex space-x-5">
              <a href="https://linkedin.com/cardiosenseai" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                <FaLinkedin className="text-2xl" />
              </a>
              <a href="https://twitter.com/cardiosenseai" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-400 hover:text-blue-300 transition-colors duration-200">
                <FaTwitter className="text-2xl" />
              </a>
              <a href="https://facebook.com/cardiosenseai" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 hover:text-blue-500 dark:hover:text-blue-500 transition-colors duration-200">
