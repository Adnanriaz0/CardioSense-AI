...
const AboutUsSection = ({ sectionRef }) => {
  return (
    <section id="about" ref={(el) => (sectionRef.current[0] = el)} className="py-20 md:py-32 bg-gray-50 dark:bg-gray-800 overflow-hidden px-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2 md:pr-8 text-center md:text-left">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-6 animate-fade-in-up-delay-300">
            Cardiovascular diseases (CVDs) remain a leading cause of mortality worldwide, often due to delayed diagnosis and insufficient continuous monitoring. Our project, the{" "}
            <strong className="text-blue-500 dark:text-blue-300">IoT Based Phonocardiogram (PCG) Monitoring and AI-Driven Analysis System</strong>, is engineered to confront this global health crisis head-on.
          </p>
          <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed animate-fade-in-up-delay-400">
            This groundbreaking solution, known as <strong className="text-blue-500 dark:text-blue-300">SmartBeat</strong>, provides real-time heart sound insights and advanced AI diagnostics. This significantly accelerates early diagnosis and enables consistent oversight, particularly in underserved and remote communities.
          </p>
        </div>
