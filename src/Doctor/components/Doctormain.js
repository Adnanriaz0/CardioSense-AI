...
import PCGUploadAndAnalysis from './PCGUploadAndAnalysis';
import PatientPcgReports from './PatientPcgReports';
        ...
        resources: {
            en: {
                translation: {
                    ...
                    "s3presence": "S3 Presence", // New translation
                    "s4presence": "S4 Presence", // New translation
                }
            },
...
const DoctorDashboard = () => {
    ...
    // const navigate = useNavigate(); // This import is not used in the provided code, commenting out.
    ...
    const pcgUploadAnalysisRef = useRef(null);
    ...
    const sectionRefs = {
        ...
        'pcg-upload-analysis-section': pcgUploadAnalysisRef,
...
const navigate = useNavigate();
  ...
  toast.success(t('logoutSuccess'));  // Show success toast
  localStorage.clear();                // Clear local storage (or remove specific keys)
